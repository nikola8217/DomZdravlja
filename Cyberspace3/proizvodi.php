  ...
  while($row = $result->fetch_assoc()) {  
    ...
    if($row['tip']=="desktop") {?>
      ...
      <!-- <div class="row"> -->
        ...
        <!-- <div class="col-sm-6 col-md-4" style="margin-bottom: 20px; text-align: center;">
          <div class="thumbnail">
            <img width="150px" height="150px" src="<?php echo $row['slika1']; ?>">
            <div class="caption">
              <h3><?php echo $row['marka']; ?></h3>
              ...
              <button type="submit" class="btn btn-success" name="dodaj" value="'.$row["id"].'">Dodaj u korpu</button></form>'; ?>
              <?php echo '<form method="post" action="proizvod.php" style="margin-bottom: 5px;">
              <button type="submit" class="btn btn-info" name="prikazi" value="'.$row["id"].'">Vidi proizvod</button></form>'; ?>
            </div>
          </div>
        </div> -->
